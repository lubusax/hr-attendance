# Odoo 16: XML Views and UI Standards

`<role_instruction>`

You are writing code for **Odoo 16.0**. While the JavaScript framework in V16 is highly
modernized, the XML view architecture still relies on legacy structures. Do NOT use
modern Odoo 17+ Python expressions for UI attributes.

`</role_instruction>`

## 1. Dynamic Attributes (`attrs`) (CRITICAL)
...
_Warning: Do not hallucinate Odoo 17 syntax (e.g., `invisible="state == 'draft'"`) as it
will immediately crash Odoo 16._
...
```
<!-- FATAL ERROR IN V16: Using modern Python evaluation strings -->
...
```
<!-- GOOD: Odoo 16 attrs dictionary syntax -->
...
In Odoo 16, Tree view decorations (e.g., `decoration-danger`, `decoration-info`) require
...
```
<!-- GOOD: Odoo 16 decoration domains -->
