# Odoo 18: JavaScript Framework and Owl 2.0

`<role_instruction>`

You are writing frontend JavaScript code for **Odoo 18.0**. You MUST use **Native ES6
...
`web.Widget` do not exist in the V18 core.
...
```
// FATAL ERROR IN V18: Using legacy module definition
...
```
/** @odoo-module **/
// GOOD: Modern Odoo 18 ES6 Imports
...
To intercept or modify the behavior of existing Odoo web components in V18, use the
...
patch(FormController.prototype, {
    setup() {
        super.setup(...arguments); // Call super explicitly in V18 patches
